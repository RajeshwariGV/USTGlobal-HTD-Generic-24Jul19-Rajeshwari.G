...
public class ContactsInfo {
	...
	public static void main(String[] args) {
		...
		Contacts raji = co.createContact("raji", 88479, "its me");
		Contacts rakhi = co.createContact("rakhi", 848499, "you");
		Contacts reddy = co.createContact("reddy", 87654321, "sissy");
		
		co.addContact("raji",raji);
		co.addContact("rakhi",rakhi);
