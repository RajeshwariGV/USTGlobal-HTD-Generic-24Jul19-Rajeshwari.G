package com.dev.finalAssesment;
...
public class threadCreation extends Thread {
	...
	static Contacts raji = co.createContact("raji", 64897647, "mee");
	static Contacts raju = co.createContact("raju", 5568678, "uu");
	static Contacts reddy = co.createContact("reddy", 87654321, "siss");
	
	
	
	@Override
	public void run() {
		co.addContact("raji",raji);
		co.addContact("raju",raju);
